...
export const ChatRoom = () => {
  ...
  return (
    <div
      className="flex flex-col h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden"
      style={{
    ...
    >
      ...
      <header className="backdrop-blur-xl bg-gray-900/70 border-b border-gray-700/50 shadow-2xl fixed top-0 left-0 right-0 z-50">
      ...
      <div className="backdrop-blur-xl bg-gray-900/70 border-t border-gray-700/50 shadow-2xl w-full overflow-hidden fixed bottom-0 left-0 right-0 z-50">
        <div className="max-w-4xl w-full mx-auto px-4 sm:px-6 py-4 box-border">
      ...
      <style>{`
        ...
        /* Ensure children inside flex can shrink on small screens */
        .min-w-0 { min-width: 0; }
